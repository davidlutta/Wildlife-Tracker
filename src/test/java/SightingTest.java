...
public class SightingTest {
    ...
    public void Sighting_InstantiatesCorrectly_True(){
        Sighting newsighting = new Sighting("Roger","Zone 1",1);
    ...
    public void find_WillReturnSightingWithTheSameID_SecnondSighting(){
        Sighting firstSighting = new Sighting("Roger","Zone 2",1);
        firstSighting.save();
        Sighting SecondSighting = new Sighting("Chris","Zone 5",3);
        SecondSighting.save();
    ...
    public void Sightings_CanBeDeletedFromDataBase_true() {
        Sighting newSighting = new Sighting("Brenden","Zone 5",1);
        newSighting.save();
        newSighting.delete();
